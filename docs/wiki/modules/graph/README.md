...
> Tier: Mixed (Tier 1: ui/, Tier 2: engine/, presentation/, Tier 3: store/, models/, domain/)
...
- [Node Types](node-types.md) — all 9 node types, UiNode sealed class
- [Commands](commands.md) — command pattern, 18 commands (21 files), undo/redo
- [Store & Sync](store.md) — sync engine, mutations, queries
