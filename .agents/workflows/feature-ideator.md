...
2. **Constraint & Style Alignment**: Ideas must align strictly with:
   ...
   - [abstraction-levels.md](file:///d:/Projects/Open/flutter/code/mycelium/.agents/plugins/code-health/rules/abstraction-levels.md) (3-tier architecture: Canvas UI, Interaction, Domain Store).
...
- **SRP & Symmetry Cautions**:
  - Analyze SRP compliance using [architecture-auditor](file:///d:/Projects/Open/flutter/code/mycelium/.agents/plugins/code-health/skills/architecture-auditor/SKILL.md) guidelines.
  - Define symmetry patterns (e.g. aligning undo commands, matching widget controller lifetimes) using [symmetry-checker](file:///d:/Projects/Open/flutter/code/mycelium/.agents/plugins/code-health/skills/symmetry-checker/SKILL.md) guidelines.
