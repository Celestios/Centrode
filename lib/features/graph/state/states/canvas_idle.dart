  ...
  CanvasInteractionState handlePointerDown(
    ...
    if (selectedEntities.isNotEmpty) {
      ...
      if (anchorTopLeft != null) {
        ...
        double toolbarWidth = AppConfig.graph.toolbar.singleWidth;
        if (isMultiSelect) {
          toolbarWidth = AppConfig.graph.toolbar.multiWidth;
        } else if (isRelationOnly) {
          toolbarWidth =
              AppConfig.graph.toolbar.buttonWidth *
    ...
    int zeroSizeRejections = 0; // [NEW] Track Size.zero bypasses
