...
// Part declarations for state subclasses
part 'states/canvas_idle.dart';
part 'states/node_dragging.dart';
part 'states/relation_drawing.dart';
part 'states/node_resizing.dart';
part 'states/toolbar_dragging.dart';
part 'states/marquee_selecting.dart';
...
double _calculateEffectiveGridSize(double scale) {
  ...
  final effectiveSize = AppConfig.graph.grid.baseSize * lod;
