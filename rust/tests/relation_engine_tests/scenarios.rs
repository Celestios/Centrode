...
pub fn all_scenarios() -> Vec<Scenario> {
    let mut scenarios = vec![
        Scenario {
            ...
            nodes: vec![node("a", 100.0, 200.0, 120.0, 80.0), node("b", 700.0, 200.0, 120.0, 80.0)],
            edges: vec![edge("e1", "a", "b", Some(PortSide::Right), Some(PortSide::Left))],
        },
        Scenario {
            label: "Horizontal offset (Right->Left, different height)",
            filename: "02_horizontal_offset",
            nodes: vec![node("a", 100.0, 200.0, 120.0, 80.0), node("b", 700.0, 380.0, 120.0, 80.0)],
            edges: vec![edge("e1", "a", "b", Some(PortSide::Right), Some(PortSide::Left))],
        },
        Scenario {
        ...
        Scenario {
            ...
            nodes: vec![node("a", 100.0, 30.0, 120.0, 80.0), node("b", 100.0, 340.0, 120.0, 80.0)],
            edges: vec![edge("e1", "a", "b", Some(PortSide::Bottom), Some(PortSide::Top))],
        },
        Scenario {
        ...
        Scenario {
            ...
            edges: vec![edge("e1", "a", "b", Some(PortSide::Top), Some(PortSide::Top))],
        },
        Scenario {
            ...
            edges: vec![edge("e1", "a", "b", Some(PortSide::Bottom), Some(PortSide::Bottom))],
        },
        Scenario {
            ...
            edges: vec![edge("e1", "a", "b", Some(PortSide::Left), Some(PortSide::Right))],
        },
        Scenario {
            ...
            edges: vec![edge("e1", "a", "b", Some(PortSide::Right), Some(PortSide::Right))],
        },
        Scenario {
            label: "Close nodes",
        ...
        Scenario {
            ...
            edges: vec![edge("e1", "a", "b", Some(PortSide::TopRight), Some(PortSide::BottomLeft))],
        },
        Scenario {
        ...
        Scenario {
            ...
            edges: vec![
                edge("e0", "hub", "n0", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e1", "hub", "n1", Some(PortSide::TopRight), Some(PortSide::Bottom)),
                edge("e2", "hub", "n2", Some(PortSide::Top), Some(PortSide::Bottom)),
                edge("e3", "hub", "n3", Some(PortSide::Left), Some(PortSide::Right)),
                edge("e4", "hub", "n4", Some(PortSide::BottomLeft), Some(PortSide::Top)),
                edge("e5", "hub", "n5", Some(PortSide::BottomRight), Some(PortSide::Top)),
            ],
        },
        Scenario {
            ...
            edges: vec![
                edge("e0", "hub", "n0", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e1", "hub", "n1", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e2", "hub", "n2", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e3", "hub", "n3", Some(PortSide::TopRight), Some(PortSide::Bottom)),
                edge("e4", "hub", "n4", Some(PortSide::BottomRight), Some(PortSide::Top)),
                edge("e5", "hub", "n5", Some(PortSide::Top), Some(PortSide::Bottom)),
                edge("e6", "hub", "n6", Some(PortSide::Bottom), Some(PortSide::Top)),
            ],
        },
        Scenario {
            ...
            edges: vec![
                edge("e_top", "hub", "n_top", Some(PortSide::Top), Some(PortSide::Bottom)),
                edge("e_right", "hub", "n_right", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e_bottom", "hub", "n_bottom", Some(PortSide::Bottom), Some(PortSide::Top)),
                edge("e_left", "hub", "n_left", Some(PortSide::Left), Some(PortSide::Right)),
                edge("e_tr", "hub", "n_tr", Some(PortSide::TopRight), Some(PortSide::BottomLeft)),
                edge("e_bl", "hub", "n_bl", Some(PortSide::BottomLeft), Some(PortSide::TopRight)),
            ],
        },
        Scenario {
            ...
            edges: vec![
                ...
                edge("e1", "hub", "n1", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e2", "hub", "n2", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e3", "hub", "n3", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e4", "hub", "n4", Some(PortSide::Right), Some(PortSide::Left)),
            ],
        },
        Scenario {
            ...
            edges: vec![
                edge("e0", "hub", "n0", Some(PortSide::Top), Some(PortSide::Bottom)),
                edge("e1", "hub", "n1", Some(PortSide::TopRight), Some(PortSide::Bottom)),
                edge("e2", "hub", "n2", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e3", "hub", "n3", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e4", "hub", "n4", Some(PortSide::BottomRight), Some(PortSide::Top)),
                edge("e5", "hub", "n5", Some(PortSide::Bottom), Some(PortSide::Top)),
                edge("e6", "hub", "n6", Some(PortSide::BottomLeft), Some(PortSide::TopRight)),
                edge("e7", "hub", "n7", Some(PortSide::TopLeft), Some(PortSide::BottomRight)),
            ],
        },
        Scenario {
            ...
            edges: vec![
                edge("e_l0", "hub", "n_l0", Some(PortSide::Left), Some(PortSide::Right)),
                edge("e_l1", "hub", "n_l1", Some(PortSide::Left), Some(PortSide::Right)),
                edge("e_l2", "hub", "n_l2", Some(PortSide::Left), Some(PortSide::Right)),
                edge("e_r0", "hub", "n_r0", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e_r1", "hub", "n_r1", Some(PortSide::Right), Some(PortSide::Left)),
                edge("e_r2", "hub", "n_r2", Some(PortSide::Right), Some(PortSide::Left)),
            ],
        },
    ];
    ...
    scenarios.push(Scenario {
        ...
        edges: vec![
            edge("e1", "a", "nonexistent", None, None),
        ],
    });
