...
use crate::domain::relation_engine::path_finder::steer::{AStarContext, Steer};
...
impl<S: Steer, H: Shaper> RoutingStrategy<S, H> {
    ...
    pub fn execute(&self, context: &AStarContext, shaper_ctx: &ShaperContext) -> (ComputedRelation, bool) {
