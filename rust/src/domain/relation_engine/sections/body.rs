...
use crate::domain::relation_engine::config::{BodyType, RelationEngineConfig};
...
fn taper_generate(
    ...
    let (lengths, total_length) = crate::domain::relation_engine::geometry::compute_cumulative_lengths(path);
...
fn width_modulate_generate(
    ...
    let (lengths, _total_length) = crate::domain::relation_engine::geometry::compute_cumulative_lengths(path);
