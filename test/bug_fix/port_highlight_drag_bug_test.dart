...
import 'package:mycelium/features/graph/ui/canvas/layers/port_layer.dart';
import 'package:mycelium/shared/domain/raw_uuid.dart';

void main() {
  testWidgets('PortLayer suppresses hoveredPort highlighting during RelationDrawing on target node', (tester) async {
    ...
    final PortPainter updatedPainter = updatedCustomPaint.painter as PortPainter;
