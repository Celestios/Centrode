...
void main() {
  ...
  group('Map Storage Deletion & Teardown Tests', () {
    ...
    setUp(() async {
      tempDir = await Directory.systemTemp.createTemp('mycelium_map_test_');
    });
    ...
    test('deleteMapStorage deletes both single files and SurrealKV directories', () async {
    ...
    test('renameMapStorage renames both single files and directories correctly', () async {
    ...
    test('MapManager handles canonical paths correctly during closeByPath', () async {
