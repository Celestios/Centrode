...
void main() {
  ...
  group('ViewportController', () {
    ...
    test(
      'elastic margins expand boundaries when node coordinates exceed padding',
      () {
        controller.updateViewportSize(const Size(100, 100));
        // Trigger calculation
        mockBoundsNotifier.value = BoundingBox(
          minX: -500,
          minY: -500,
          maxX: 500,
          maxY: 500,
    ...
    test('animateViewportTo initiates animation successfully', () {
      ...
      final initialTranslation = controller.transformController.value
          .getTranslation();
