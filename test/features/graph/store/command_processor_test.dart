...
void main() {
  group('CommandProcessor', () {
    ...
    test('executes immediate command right away', () {
      fakeAsync((async) {
    ...
    test('debounces non-immediate command', () {
      fakeAsync((async) {
        final cmd = FakeCommand(
    ...
    test('overwrites previous pending command of same category', () {
      fakeAsync((async) {
    ...
    test('keeps pending commands of different categories', () {
      fakeAsync((async) {
        final cmd1 = FakeCommand(
